...
import lombok.*;
import net.projectmythos.argos.models.afk.events.NotAFKEvent;
import net.projectmythos.argos.models.afk.events.NowAFKEvent;
...
import net.projectmythos.argos.utils.WorldGuardUtils;
...
//        broadcast();
    ...
    public void message() {
        if (afk)
            sendMessage("&7You are now AFK" + (message == null ? "" : ". Your auto-reply message is set to:\n &e" + message));
        else
            sendMessage("&7You are no longer AFK");
    }

    // TODO: uncomment when doing broadcast

//    private void broadcast() {
//        if (!isOnline() || !getSetting(AFKSetting.BROADCASTS))
//            return;
//
//        // TODO: uncomment if doing mute menu
//
//        Broadcast.ingame()
//                .sender(this)
//                .exclude(uuid)
