...
import net.projectmythos.argos.features.menus.MenuUtils;
import net.projectmythos.argos.utils.JsonBuilder;
import net.projectmythos.argos.utils.MathUtils;
...
public final class SignMenuFactory {
	...
	public static final class Menu {
		...
		public void open(Player player) {
			...
			Argos.getSignMenuFactory().signLocations.put(player, position);
			Argos.getSignMenuFactory().inputReceivers.putIfAbsent(player, this);
		}
	}
}
