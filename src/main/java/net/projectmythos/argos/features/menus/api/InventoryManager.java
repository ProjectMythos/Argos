...
import net.projectmythos.argos.features.menus.api.opener.ChestInventoryOpener;
import net.projectmythos.argos.features.menus.api.opener.InventoryOpener;
import net.projectmythos.argos.features.menus.api.opener.SpecialInventoryOpener;
...
public class InventoryManager implements Listener {
	...
	public void onInventoryDrag(InventoryDragEvent event) {
		...
		if (clickedContents == null) {
			Argos.log("Could not find clicked inventory");
			Thread.dumpStack();
			return;
		}
