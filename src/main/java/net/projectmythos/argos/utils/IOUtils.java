...
import static net.projectmythos.argos.utils.TimeUtils.shortDateTimeFormat;

public class IOUtils {
	public final static String PLUGIN_ROOT = "plugins/" + Argos.class.getSimpleName() + "/";
	...
	private static void write(String fileName, List<StandardOpenOption> openOptions, UncheckedConsumer<BufferedWriter> consumer) {
		Tasks.async(() -> {
			synchronized (Argos.getInstance()) {
				try {
