...
import net.projectmythos.argos.framework.interfaces.IsColored;
import net.projectmythos.argos.models.nickname.Nickname;
import net.projectmythos.argos.models.skincache.SkinCache;
import net.projectmythos.argos.utils.TimeUtils.TickTime;
import net.projectmythos.argos.utils.SymbolBanner.Symbol;
import org.bukkit.*;
...
import static net.projectmythos.argos.utils.StringUtils.colorize;
...
//	}
	...
	public static ItemBuilder fromHeadId(String id) {
		return new ItemBuilder(Argos.getHeadAPI().getItemHead(id));
	}
	...
	public ItemBuilder mapId(int id, MapRenderer renderer) {
		...
		if (view == null) {
			Argos.log("View for map id " + id + " is null");
...
//	}
	...
	//TODO: uncomment if doing item rarities
...
//	}
	...
	public enum ItemSetting {
		...
		TRADEABLE(true) {
			...
			//TODO: uncomment if doing backpacks
