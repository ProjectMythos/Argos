...
public class Features {
	...
	public static <T extends Feature> T get(Class<T> clazz) {
		return (T) Optional.of(registered.get(clazz)).orElseThrow(() -> new ArgosException("Feature " + prettyName(clazz) + " not found"));
	}
	...
	public void registerAll() {
		Argos.debug(" Registering " + featureSet.size() + " features");
